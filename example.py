...
##on your Ucomputer, with your own keyboard, manipulate variables, files, and import them, you can 'print a file', copy a file or modify it with the help of shell_commands.py.
